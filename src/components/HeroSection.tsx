        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-right space-y-8 order-1">
            ...
            <motion.div
              ...
              className="inline-flex items-center justify-center gap-3 rounded-full px-5 py-2.5 mx-auto lg:mx-0"
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-white/70 leading-[2] font-medium max-w-xl mx-auto lg:mr-auto lg:ml-0"
            >
            ...
            >
              <Link to="/form" onMouseEnter={prefetchForm} onFocus={prefetchForm} onTouchStart={prefetchForm} className="w-full sm:w-auto">
                <motion.button
                  ...
                  className="relative group w-full sm:w-auto px-10 py-4 rounded-full text-base md:text-lg font-black text-white shadow-2xl overflow-hidden"
              ...
              <a href="tel:+966532759488" className="w-full sm:w-auto">
                <motion.button
                  whileHover={{ scale: 1.05, y: -3 }}
                  whileTap={{ scale: 0.97 }}
                  className="w-full sm:w-auto px-8 py-4 rounded-full text-base font-bold text-white/90 backdrop-blur-sm transition-all"
            ...
            <motion.div
              ...
              className="grid grid-cols-3 gap-3 md:gap-6 pt-8"
          ...
          >
            ...
            <div
              className="absolute w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-full blur-[80px] md:blur-[100px] opacity-40"
              style={{ background: "radial-gradient(circle, #9b50e8, transparent 70%)" }}
            />
            
            {/* Hero graphics container */}
            <motion.div
              className="relative z-10 w-[85%] sm:w-full max-w-xs md:max-w-xl lg:max-w-2xl xl:max-w-3xl mx-auto flex items-center justify-center transform lg:scale-110 lg:-translate-x-6"
              animate={{ y: [0, -14, 0] }}
            ...
            <motion.div
              ...
              className="absolute bottom-4 right-0 md:bottom-8 md:-right-8 rounded-xl md:rounded-2xl px-3 py-2 md:px-5 md:py-3 z-20"
            ...
            <motion.div
              ...
              className="absolute top-4 left-0 md:top-8 md:-left-8 rounded-xl md:rounded-2xl px-3 py-2 md:px-5 md:py-3 z-20"
              style={{ background: "rgba(13,5,32,0.9)", border: "1px solid rgba(155,80,232,0.3)", backdropFilter: "blur(16px)" }}
            >
